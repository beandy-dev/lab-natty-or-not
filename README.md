...
## Contexto do Desafio
Este projeto foi desenvolvido como parte do Lab “Natty or Not” da DIO (Digital Innovation One), cujo objetivo é explorar o uso de IA Generativa na criação de conteúdos que se aproximem ao máximo de produções humanas (“natty”), de forma criativa e consciente.

Inspirado na tendência “Natty or Not”, o desafio propõe:
- Explorar o potencial das IAs Generativas
- Criar um projeto autoral
- Versionar o projeto em um repositório GitHub para compor no portfólio
...
## Processo de Criação
A criação partiu de uma concepção autoral humana (ou seja, minha), que definiu tema, atmosfera, cenário e limites narrativos do conto com base no esboço de uma ideia antiga do roteiro de um curta metragem. A partir dessas diretrizes, o texto foi desenvolvido em colaboração com uma IA generativa, em um processo iterativo de expansão, refinamento de linguagem e ajuste de ritmo narrativo.
